namespace WebServer.GameStoreApplication.ViewModels.Admin
{
    ...
    public class AdminEditGameViewModel
    {
        ...
        [MinLength(ValidationConstants.Game.VideoLength, ErrorMessage = ValidationConstants.ExactLengthErrorMessage)]
        [MaxLength(ValidationConstants.Game.VideoLength, ErrorMessage = ValidationConstants.ExactLengthErrorMessage)]
