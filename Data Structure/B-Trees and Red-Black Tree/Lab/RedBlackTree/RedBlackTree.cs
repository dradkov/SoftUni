...
public class RedBlackTree<T> : IBinarySearchTree<T> where T : IComparable
{
    ...
    {
        Node newRootTree = node.Right;
        node.Right = newRootTree.Left;
        newRootTree.Left = node;

        newRootTree.Color = node.Color;
        node.Color = Red;
        newRootTree.Count = node.Count;
    ...
    private Node RoteteRight(Node node)
    {
        Node newRootTree = node.Left;
        node.Left = newRootTree.Right;
        newRootTree.Right  = node;
